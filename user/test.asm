...
void example_pause_system(int interval, int pause_seconds, int loop_size) {
  ...
  1e:	30e080e7          	jalr	782(ra) # 328 <fork>
  22:	00000097          	auipc	ra,0x0
  26:	306080e7          	jalr	774(ra) # 328 <fork>
    }
  ...
  40:	824b0b13          	addi	s6,s6,-2012 # 860 <malloc+0xea>
  44:	a829                	j	5e <example_pause_system+0x5e>
  46:	864a                	mv	a2,s2
  48:	85a6                	mv	a1,s1
  4a:	855a                	mv	a0,s6
  4c:	00000097          	auipc	ra,0x0
  50:	66c080e7          	jalr	1644(ra) # 6b8 <printf>
        if (i == loop_size / 2){
  ...
  6c:	370080e7          	jalr	880(ra) # 3d8 <pause_system>
  70:	b7e5                	j	58 <example_pause_system+0x58>
        }
    }
    printf("\n");
  72:	00001517          	auipc	a0,0x1
  76:	80e50513          	addi	a0,a0,-2034 # 880 <malloc+0x10a>
  7a:	00000097          	auipc	ra,0x0
  7e:	63e080e7          	jalr	1598(ra) # 6b8 <printf>
}
  82:	70e2                	ld	ra,56(sp)
  84:	7442                	ld	s0,48(sp)
  86:	74a2                	ld	s1,40(sp)
...
int main(int argc, char ** argv){
  ...
  9e:	3e800613          	li	a2,1000
  a2:	4595                	li	a1,5
  a4:	06400513          	li	a0,100
  a8:	00000097          	auipc	ra,0x0
  ac:	f58080e7          	jalr	-168(ra) # 0 <example_pause_system>
    exit(0);
  b0:	4501                	li	a0,0
